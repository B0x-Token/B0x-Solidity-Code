...
contract MyERC721 is IERC165, IERC721, IERC721Metadata {
    ...
    // Optional mapping for token URIs (for individual token metadata)
    mapping(uint256 => string) private _tokenURIs;
    
    // Current token ID counter
    uint256 private _currentTokenId;

    constructor(string memory name_, string memory symbol_, string memory baseURI_, address MintTo) {
        _name = name_;
        _symbol = symbol_;
    ...
    function setBaseURI(string memory baseURI_) public virtual {
        // In a real implementation, you'd want access control here (onlyOwner, etc.)
        _baseTokenURI = baseURI_;
    }
...
contract MyERC1155 is IERC165, IERC1155 {
    ...
    constructor(string memory uri_, address mintTo) {
        _setURI(uri_);
